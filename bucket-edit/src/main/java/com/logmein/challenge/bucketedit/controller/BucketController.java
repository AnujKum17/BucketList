...
public class BucketController implements IBucketApi {
    ...
    public ResponseEntity<UUID> addItem(@Validated @RequestBody OrderItem orderItemDTO){
    ...
    public ResponseEntity<Void> modifyItem(@Validated @RequestBody OrderItem orderItemDTO) {
    ...
    public ResponseEntity<Void> deleteItem(@NotNull @PathVariable String userID,@NotNull @PathVariable UUID itemID){
